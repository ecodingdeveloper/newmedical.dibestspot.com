...
class Packages extends CI_Controller {
  ...
  {   
   ...
   // $data["product_image"] = $this->input->post('product_img');
    ...
    $data["accomodation"] = $this->input->post('package_accomodation');
    $data["itinerary"] = $this->input->post('package_itinerary');
    ...
    public function package_list()
    {
      ...
      if(file_exists(FCPATH.$pr_img[0])){
        ...
        $row[] = '<h2 class="table-avatar">
                      ...
                      <a href="javascript:void(0);">'.$packages['name'].'</a>
                   </h2>';
        $row[] = '<div class="actions">
                    <a class="btn btn-sm bg-success-light" onclick="edit_product_admin('.$packages['id'].')" href="javascript:void(0)">
                      <i class="fe fe-pencil"></i> Edit
                    </a>
                    <a class="btn btn-sm bg-danger-light" href="javascript:void(0)" onclick="delete_product_admin('.$packages['id'].')">
