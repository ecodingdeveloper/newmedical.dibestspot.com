...
class Commission_clinic_model extends CI_Model {
	...
	public function get_commission_by_clinic_id($clinic_id) {
        $query = $this->db->get_where('commission_clinic', array('clinic_id' => $clinic_id));
        return $query->row(); // Returns a single row object
    }
   ...
   /* public function get_all_commissions() {
    ...
    public function insert_commission($clinic_id, $comm_rate) {
		$data = array(
        'clinic_id' => $clinic_id,
        'comm_rate' => $comm_rate
    );
        return $this->db->insert('commission_clinic', $data);
    }
	...
	public function update_commission($clinic_id, $comm_rate) {
    ...
    return $this->db->update('commission_clinic', $data);
}
