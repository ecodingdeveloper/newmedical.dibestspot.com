...
class Services_model extends CI_Model
{
  ...
  var $services_column_order = array(
    '',
    'services.name',
    ''
  );
  var $services_default_column_order = array('services.id'=>'DESC');
  ...
  private function _get_datatables_query()
{
    ...
    {
        $this->db->order_by($this->services_column_order[$_POST['order']['0']['column']], $_POST['order']['0']['dir']);
    } 
    else if (isset($this->services_default_column_order))
    {
        $order = $this->services_default_column_order;
