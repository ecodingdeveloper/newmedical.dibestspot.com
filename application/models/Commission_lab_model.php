...
class Commission_lab_model extends CI_Model {
	...
	public function get_commission_by_lab_id($lab_id) {
        $query = $this->db->get_where('commission_lab', array('lab_id' => $lab_id));
        return $query->row(); // Returns a single row object
    }
   ...
   /* public function get_all_commissions() {
    ...
    public function insert_commission($lab_id, $comm_rate) {
		$data = array(
        'lab_id' => $lab_id,
        'comm_rate' => $comm_rate
    );
        return $this->db->insert('commission_lab', $data);
    }
	...
	public function update_commission($lab_id, $comm_rate) {
    ...
    return $this->db->update('commission_lab', $data);
}
