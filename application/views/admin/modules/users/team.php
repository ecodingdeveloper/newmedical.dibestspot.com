					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-7 col-auto">
								<h3 class="page-title">List of Team Member</h3>
								<ul class="breadcrumb">
							...
							<div class="col-sm-5 col">
								<a href="#user_modal" data-toggle="modal" class="btn btn-primary float-right mt-2">Add Team Member</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">
										<table id="team_table" class="table table-hover table-center mb-0 w-100">
											<thead>
												<tr>
													<th>S. No.</th>
													<th>Id</th>
								...
								<div class="row form-row">
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>Team First Name <span class="text-danger">*</span></label>
