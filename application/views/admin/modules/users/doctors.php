					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-sm-5 col">
								<a href="#user_modal" data-toggle="modal" class="btn btn-primary float-right mt-2">Add Doctor</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">
										<table id="doctors_table" class="table table-hover table-center mb-0 w-100">
											<thead>
												<tr>
													<th>S.No</th>
													<th>Id</th>
								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" maxlength="15" onKeyPress="if(this.value.length==15) return false;" name="mobileno" id="mobileno" class="form-control">
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="form-group">
