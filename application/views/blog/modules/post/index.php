							...
							<div class="card card-table">
									...
									<div class="row">
										<div class="col">
											<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded">
												<li class="nav-item">
													<a class="nav-link active" href="<?php echo base_url();?>blog/post"><?php echo $language['lg_acitive_blog'];?></a>
												</li>
												<li class="nav-item">
													<a class="nav-link" href="<?php echo base_url();?>blog/pending-post"><?php echo $language['lg_pending_blog'];?></a>
												</li> 
											</ul>
										</div>
										<div class="col-auto">
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<input type="hidden" id="posts_type" value="1">
