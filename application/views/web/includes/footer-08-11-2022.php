              ...
              <div class="row">
                <div class="col-md-6 col-lg-6">
                  <div class="copyright-text">
                    <p class="mb-0">&copy; <?php echo date('Y');?> <?php echo !empty(settings("website_name"))?settings("website_name"):"Doccure";?>. <?php echo $language['lg_all_rights_rese']; ?></p>
                  </div>
                </div>
                <div class="col-md-6 col-lg-6">
...
/** @var string $module */
/** @var string $page */
if($module=='doctor' || $module=='patient' || $module=='pharmacy' || $module=='lab'){ if($page=='appoinments' || $page=='doctor_dashboard' || $page=='lab_appoinments') { ?>
  ...
  <?php } if($page=='doctor_profile' || $page=='patient_profile' || $page == 'pharmacy_profile' || $page=='lab_profile') { ?>
...
<div class="modal fade custom-modal" id="clinicModel">
          <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <h3 class="modal-title"><?php echo "Doctor Info";//$clinicInfo;?></h3>
                  ...
                  <div class="card">
                        ...
                        ?>
                                  <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <select class="form-control select" name="doc_specialization"
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              /** @var array $profile */
                              echo $profile['clinic_address2'];?>"
                                  name="clinic_address2" id="clinic_address2" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $profile['clinic_city'];?>" name="clinic_city"
                                  id="clinic_city" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $profile['clinic_state'];?>" name="clinic_state"
                                  id="clinic_state" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $profile['clinic_country'];?>" name="clinic_country"
                                  id="clinic_country" class="form-control">
                          </div>
                      </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <input type="text" value="<?php echo $profile['clinic_postal'];?>" name="clinic_postal"
                                  id="clinic_postal" class="form-control">
                          </div>
                      </div>
                  </div>
                  <button type="submit" id="clinicsave_btn"
                      class="btn btn-primary submit-btn"><?php echo $language['lg_save_changes'];?></button>
  ...
  <?php } if($page=='add_prescription' || $page=='edit_prescription' || $page=='add_billing' || $page=='edit_billing') {  ?>
   ...
   <div class="modal fade" id="sign-modal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content" id="signature-pad">
      ...
      <div class="modal-body">
        <canvas width="460" height="318"></canvas>
          ...
          <div class="modal-body">
            <form id="accounts_form" method="post">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label"><?php echo $language['lg_bank_name']; ?></label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label"><?php echo $language['lg_branch_name']; ?></label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label"><?php echo $language['lg_account_number']; ?></label>
                    <input type="text" name="account_no" class="form-control account_no" value="" id="account_no">
                    <span class="help-block"></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label"><?php echo $language['lg_account_holder_']; ?></label>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label><?php echo $language['lg_request_amount']; ?></label>
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <select class="form-control" id="user_role" onchange="social_register()">
              <option value=""><?php echo $language['lg_select_role']; ?></option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label for="slug" class="control-label mb-10">Amount </label>
                    <input type="text" parsley-trigger="change" id="amount" name="amount"  class="form-control" >
                </div>
                <div class="form-group">
                    <label for="slug" class="control-label mb-10" onload='document.form1.text1.focus()'>Duration </label>
                ...
                <div class="form-group">
                    <label for="slug" class="control-label mb-10">Description </label>
 ...
 <audio id="myAudio">
  ...
  <?php $this->load->view('web/modules/language_scripts/scripts');?>
    ...
    <script src="<?php echo base_url();?>assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js"></script>
     ...
     <?php 
/** @var string $theme */
     if($module=='doctor' || $module=='patient' || $module=='calendar' || $module=='invoice' || $module=='lab' || $theme=='blog' || $page=='doctors_search'  || $page=='doctors_searchmap'  || $page=='doctors_mapsearch' || $page=='patients_search' || $module == 'pharmacy' || $page=='products_list' || $page=='pharmacy_search_bydoctor' || $page=='products_list_by_pharmacy'){ ?>
...
if(($module=='doctor' || $module=='patient' || $module=='lab') && ($page=='doctor_profile' || $page=='patient_profile' || $module == 'pharmacy') || $page=='doctors_search' || $page=='doctors_searchmap' || $page=='doctors_mapsearch' || $page=='patients_search' || $page=='schedule_timings' || $page == 'pharmacy_profile' || $page == 'lab_tests_preview') { ?> 

   <?php } 
       
   if(($module=='doctor' || $module=='subscription' || $module=='patient' || $module=='post' || $module=='calendar' || $module=='invoice' || $module=='pharmacy' || $module=='home' || $module=='ecommerce' || $module=='lab')) {  
   ...
   if($page=='doctor_profile' || $page=='add_product') { ?>
    ...
    <?php } if($page=='calendar' || $page=='add_product'){ ?>
  ...
  if($module=='signin'||($module=='doctor' || $module=='patient' || $module=='post' || $module=='pharmacy' || $module=='ecommerce' || $module=='lab') && ($page=='doctor_profile' || $page=='patient_profile' || $page=='schedule_timings'|| $page=='add_prescription' || $page=='edit_prescription' || $page=='add_billing' || $page=='edit_billing'|| $page=='change_password' || $page=='add_post' || $page=='edit_post' || $page=='social_media' || $page=='checkout' || $page=='add_product' || $page=='edit_product' || $page=='pharmacy_profile' || $page=='checkout' || $page == 'lab_profile' || $page=='add_doctor' || $page=='accounts')){ ?>
   ...
   <script type="text/javascript">
    ...
    <?php } if($this->session->userdata('user_id') !=''){ if($module !='pharmacy' && $page !='checkout' && $page !='schedule_timings') { ?>
     <script src="<?php echo base_url();?>assets/js/appoinments.js"></script>
     <script src="<?php echo base_url();?>assets/js/messages.js"></script>
    <?php } } if($theme=='blog' || $module=='pharmacy') { if($module=='home' && $page=='blog_details') { ?> 
       <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery-confirm.min.js"></script>
     <?php } 

     if($module=='post' || $module=='pharmacy') { if($page=='add_post' || $page=='edit_post' || $page=='add_product' || $page=='edit_product') { ?>
      <script src="<?php echo base_url();?>assets/plugins/bootstrap-tagsinput/js/bootstrap-tagsinput.js"></script>
...
<?php } ?>
    ...
    <script type="text/javascript">  
       ...
       function social_register(){
               ...
               $.post(base_url + 'signin/social_register',{'first_name':first_name,'last_name':last_name,'email':email,'user_role':user_role},function(response){
                      var obj = JSON.parse(response);
                        if (obj.status===200) {
                              window.location.href=base_url+'dashboard';
                        }  if (obj.status===500) {
            ...
            auth2.attachClickHandler(element, {},
                function(googleUser) {
                   ...
                   var role=2;
                    ...
                    $.post(base_url + 'signin/social_signin',{'email':email,'role':role},function(response){
                          var obj = JSON.parse(response);
                            if (obj.status===200) {
                ...
                auth2.attachClickHandler(element, {},
                    function(googleUser) {
                       ...
                       var role=2;
                        ...
                        $.post(base_url + 'signin/social_register',{'first_name':first_name,'last_name':last_name,'email':email,'user_role':role},function(response){
                          var obj = JSON.parse(response);
                            if (obj.status===200) {
                                  window.location.reload();
                            }  if (obj.status===500) {
