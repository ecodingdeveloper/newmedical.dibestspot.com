											...
											<div class="navbar">
												<div class="user-details">
													<div class="float-left user-img">
														<a class="avatar avatar-sm mr-2" href="#" title="<?php 
                             /** @var string $name */
														echo $name;?>">
															<img src="<?php echo $profileimage;?>" alt="<?php echo $name;?>" class="rounded-circle">
										...
										<div class="call-footer">
											<div class="call-icons">
												...
												<ul class="call-items">
													...
													<li class="call-item">
														<a href="javascript:void(0);" id="video_disable" title="Disable Video" data-placement="top" data-toggle="tooltip">
															<i class="fas fa-video camera"></i>
														</a>
														<a href="javascript:void(0);" id="video_enable" title="Enable Video" data-placement="top" data-toggle="tooltip">
