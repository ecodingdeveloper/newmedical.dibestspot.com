										...
										<div class="col-md-12 col-lg-6">
											...
											<form method="post" action="#" autocomplete="off" id="change_password">
												...
												<div class="form-group">
													...
													<input type="password" name="confirm_password" id="confirm_password" class="form-control">													<span class="far fa-eye" id="togglePassword2"></span> 		
												</div>
												<div class="submit-section">
													<button type="submit" id="change_password_btn" class="btn btn-primary submit-btn"><?php echo $language['lg_change_password'];?></button>
												</div>
											</form>
											<!-- /Change Password Form -->
