      ...
      <div class="row align-items-center">
         <div class="col-md-12 col-12">
            <nav aria-label="breadcrumb" class="page-breadcrumb">
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo base_url();?>invoice"><?php
                  /** @var array $language  */
                   echo $language['lg_invoice']; ?></a></li>
                  <li class="breadcrumb-item active" aria-current="page"><?php echo $language['lg_order_view']; ?></li>
               </ol>
            </nav>
            <h2 class="breadcrumb-title"><?php echo $language['lg_order_view']; ?></h2>
         </div>
      </div>
   </div>
</div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <p class="invoice-details">
                           <strong><?php echo $language['lg_order_no1']; ?>:</strong> <?php 
                           /** @var array $invoices  */
                           echo $invoices[0]['order_id'];?> <br>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="invoice-info">
                           <strong class="customer-text"><?php echo $language['lg_order_from']; ?></strong>
                     ...
                     <div class="col-md-6">
                        <div class="invoice-info invoice-info2">
                           <strong class="customer-text"><?php echo $language['lg_order_to']; ?></strong>
                           <p class="invoice-details">
