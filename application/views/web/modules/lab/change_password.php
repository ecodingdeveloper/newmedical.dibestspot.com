			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
							...
							<!-- Profile Sidebar -->
							<?php $this->load->view('web/includes/lab_sidebar.php');?>
							<!-- Profile Sidebar -->
							</div>
										...
										<div class="col-md-12 col-lg-6">
											...
											<form method="post" action="#" autocomplete="off" id="change_password">
												...
												<div class="submit-section">
													<button type="submit" id="change_password_btn" class="btn btn-primary submit-btn"><?php echo $language['lg_pwd_change_btn_label'];?></button>
												</div>
											</form>
											<!-- /Change Password Form -->
